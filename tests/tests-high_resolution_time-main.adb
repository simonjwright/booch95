...
--  $Author$
--
--  Tests for Booch Components High Resolution Time.

with AUnit.Reporter.Text;
with AUnit.Run;
with AUnit.Test_Suites;

procedure Tests.High_Resolution_Time.Main is
   ...
   begin
      AUnit.Test_Suites.Add_Test (Result, High_Resolution_Time.Suite);
      return Result;
   end Suites;
...
begin
   Run (Reporter);
end Tests.High_Resolution_Time.Main;
