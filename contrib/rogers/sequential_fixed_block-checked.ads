...
package Sequential_Fixed_Block.Checked is
   ...
   --  Instances of Unchecked_Deallocation, which call Deallocate, will
   --  check that prior calls with the same access value do not attempt
   --  to deallocate the same access value, thereby preventing heap
   --  corruption.
