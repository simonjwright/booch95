...
package BC.Containers.Maps is
  ...
  -- The parameter Key denotes the universe from which the map draws its
  -- doamin; the parameter Item denotes the universe from which the map
  -- draws its range. The parameters Key and Item typically represent
