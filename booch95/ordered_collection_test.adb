...
procedure Ordered_Collection_Test is
  ...
  begin
    ...
    Remove (C1, 2);
    Remove (C1, 1);
    Assertion (Item_At (C1, 1) = '9', "** P16: Collection Item is not correct");
    ...
    Assertion (Item_At (C1, 1) = '9', "** P28: Collection Item is not correct");
    ...
    Replace (C1, 7, 'A');
    Assertion (Item_At (C1, 1) = 'A', "** P34: Collection Item is not correct");
    Replace (C1, 1, 'g');
    Append (C1, 'A');
