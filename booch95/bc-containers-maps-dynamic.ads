...
--| class BC_TDynamicMap : public BC_TMap<Item, Value> {
--| public:
--|
--|   BC_TDynamicMap();
--|   BC_TDynamicMap(BC_Index (*Hash)(const Item&));
--|   BC_TDynamicMap(BC_Index chunkSize);
--|   BC_TDynamicMap(const BC_TDynamicMap<Item, Value, Buckets, StorageManager>&);
--|   virtual ~BC_TDynamicMap();
--|
--|   virtual BC_TMap<Item, Value>& operator=(const BC_TMap<Item, Value>&);
--|   virtual BC_TMap<Item, Value>&
--|     operator=(const BC_TDynamicMap<Item, Value, Buckets, StorageManager>&);
--|   virtual BC_Boolean operator==(const BC_TMap<Item, Value>&) const;
--|   virtual BC_Boolean
--|     operator==(const BC_TDynamicMap<Item, Value, Buckets, StorageManager>&) const;
--|   BC_Boolean
--|     operator!=(const BC_TDynamicMap<Item, Value, Buckets, StorageManager>&) const;
--|
...
--|             BC_TDynamic<Item, StorageManager>, BC_TDynamic<Value, StorageManager> > fRep;
--|
--|   virtual void Purge();
