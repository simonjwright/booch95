...
package body BC.Containers.Bags is
   ...
   begin
      ...
      --  Iterator may not be completely synchronised (for example,
      --  see Intersection, where we've either called Next or Detach).
      --
      --  This means we may need to write to the Iterator; but it's an
      --  in parameter.
      declare
         package Conversions is new System.Address_To_Access_Conversions
           (Bag_Iterator'Class);
         It_W : Bag_Iterator'Class
           renames Conversions.To_Pointer (It'Address).all;
      begin
