...
package BC.Containers.Lists.Single is
  ...
  procedure Clear (L : in out Single_List);
  ...
  procedure Insert (L : in out Single_List; Elem : Item);
  -- Add the item to the head of the list.

  procedure Insert (L : in out Single_List; From_List : in Single_List);
  -- Add the given list to the head of the list.

  procedure Insert (L : in out Single_List; Elem : Item; Before : Positive);
  ...
  procedure Append (L : in out Single_List; Elem : Item);
  -- Add the item at the end of the list.

  procedure Append (L : in out Single_List; From_List : in Single_List);
  -- Add the given list at the end of the list.

  procedure Append (L : in out Single_List; Elem : Item; After : Positive);
  ...
  procedure Remove (L : in out Single_List; From : Positive);
  -- Remove the item at the given index in the list.

  procedure Purge (L : in out Single_List; From : Positive);
  -- Remove all the items in the list starting at the given index,
  -- inclusive.

  procedure Purge (L : in out Single_List; From : Positive; Count : Positive);
  -- Remove all the items in the list starting at the given index,
  -- inclusive, for a total of count items.

  procedure Preserve (L : in out Single_List; From : Positive);
  ...
  procedure Share_Head (L : in out Single_List; With_List : in Single_List);
  -- Clear the list, then, if the given list is not null, set the list to
  -- structurally share with the head of the given list.

  procedure Share_Foot (L : in out Single_List; With_List : in Single_List);
  -- Clear the list, then, if the given list is not null, set the list to
  ...
  procedure Tail (L : in out Single_List);
  ...
  procedure Set_Head (L : in out Single_List; Elem : Item);
  ...
  function Length (L : Single_List) return Natural;
  -- Return the number of items in the list.

  function Is_Null (L : Single_List) return Boolean;
  -- Return True if and only there are no items in the list.

  function Is_Shared (L : Single_List) return Boolean;
...
private
  ...
  procedure Initialize (L : in out Single_List);
