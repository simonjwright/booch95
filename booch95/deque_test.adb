...
procedure Deque_Test is
  ...
  begin
    ...
    Append(D2, '3');
    Append(D2, '4');
    Assertion (Location (D2, '1') = 1, "** P32: Deque location is not correct");
    Assertion (Location (D2, '2') = 2, "** P33: Deque location is not correct");
    Assertion (Location (D2, '4') = 4, "** P34: Deque location is not correct");
    Remove(D2, 1);
    Remove(D2, 2);
    Remove(D2, 2);
